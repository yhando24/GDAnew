		...
		<div class="card card-login mx-auto mt-5">
			...
			<div class="card-body">
				...
				<div class="text-center mb-4">
					...
					<p>Entrer votre adresse email et nous vous enverrons les
						instructions pour récupérer votre mot de passe</p>
				</div>
				<form>
					<div class="form-group">
						<div class="form-label-group">
							<input type="email" id="inputEmail" class="form-control"
								...
								autofocus="autofocus"> <label for="inputEmail">Adresse
								email</label>
						</div>
					</div>
				...
				<div class="text-center">
					<a class="d-block small mt-3" href="login.html">Page de
						connection</a>
				</div>
			</div>
		</div>
