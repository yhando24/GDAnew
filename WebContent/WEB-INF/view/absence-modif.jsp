            ...
            <div class="form-row">
                <div class='form-group col-md-6 offset-md-3'>
                    ...
                    <form action='<c:url value="/update-absence"/>' method="POST"> 
                        ...
                        <span class="messageFinDate" style="display:none; color:red">Date de fin inférieure à la date de début. Veuillez saisir une date de fin correcte svp</span> 
                        <span>
                        ...
                        <span>
                            ...
                            <textarea id="motifJs" type="text" id="message" name="motif" rows="2" class="form-control md-textarea">${absenceAModifier.reason}</textarea>
                        </span>
