                            ...
                            <c:forEach items="${allUsers}" var="user" varStatus="status">
                                 ...
                                 <tr>
                                    ...
                                    <td > <c:forEach items="${user.absences}" var="absence" varStatus="status">  ${absence.absenceType.name} </td> 
                             		<td>   <a href="<c:url value ="/validation?action=validAbsence&id=${absence.id }"/>"><i class="fas fa-check"></i> </i>
                    </a>   <a href="<c:url value ="/validation?action=refuseAbsence&id=${absence.id }"/>"> <i class="fas fa-times-circle"></i>
                    </a></i></c:forEach> </td>
