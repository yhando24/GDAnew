...
-- -----------------------------------------------------
-- Table `diginamicproject`.`departement_typedayoff`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `diginamicproject`.`departement_typedayoff` (
`departement_id` INT(11) NOT NULL,
`typedayoff_id` INT(11) NOT NULL,
PRIMARY KEY (`departement_id`, `typedayoff_id`),
INDEX `fk_departement_has_typedayoff_typedayoff1_idx` (`typedayoff_id` ASC),
INDEX `fk_departement_has_typedayoff_departement1_idx` (`departement_id` ASC),
CONSTRAINT `fk_departement_has_typedayoff_departement1`
FOREIGN KEY (`departement_id`)
REFERENCES `diginamicproject`.`departement` (`id`)
ON DELETE NO ACTION
ON UPDATE NO ACTION,
CONSTRAINT `fk_departement_has_typedayoff_typedayoff1`
FOREIGN KEY (`typedayoff_id`)
REFERENCES `diginamicproject`.`typedayoff` (`id`)
ON DELETE NO ACTION
ON UPDATE NO ACTION)
ENGINE = InnoDB
